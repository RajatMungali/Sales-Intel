    ...
    <div className="grid grid-cols-4 gap-5 mb-6">
      {cards.map(
        ({
          ...
          <div
            key={key}
            className="bg-white border border-gray-100 rounded-2xl p-5 flex items-start gap-3 shadow-[0_2px_12px_rgba(15,23,42,0.06)] hover:shadow-[0_4px_20px_rgba(15,23,42,0.10)] transition-shadow duration-200"
          >
            <div
              className={`w-10 h-10 rounded-xl ${iconBg} flex items-center justify-center flex-shrink-0 mt-0.5`}
            >
